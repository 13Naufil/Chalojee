<?php
 ...
 //params
$CityCode = "26790";
$IsDetailedResponse = 1;


 $url = "http://api.tbotechnology.in/HotelAPI_V7/HotelService.svc?singleWsdl";
 $action = "http://TekTravel/HotelBookingApi/GiataHotelCodeList";
...
xmlns:hot="http://TekTravel/HotelBookingApi">
  <soap:Header xmlns:wsa="http://www.w3.org/2005/08/addressing">
    ...
    <wsa:Action>http://TekTravel/HotelBookingApi/GiataHotelCodeList</wsa:Action>
    <wsa:To>http://api.tbotechnology.in/HotelAPI_V7/HotelService.svc</wsa:To>
  </soap:Header>
  <soap:Body>
    <hot:GiataHotelCodeListRequest>
